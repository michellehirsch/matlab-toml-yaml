...
%[text] Keys with embedded dots (quoted in TOML)
"Key with literal dot: " + data.("another.key")
"Key with spaces: " + data.("spaces in key")
%%
...
%%
%[text] ## Nested Array of Tables
%[text] Arrays of tables can contain nested structures
tomlNestedArray = [...
    '[[jobs]]', newline, ...
    'name = "build"', newline, ...
    '', newline, ...
...
%[text] Complex workflow with nested arrays:
%[text] Navigate nested array of tables
